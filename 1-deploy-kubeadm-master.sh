#!/bin/bash
multipass launch ubuntu --name master --cpus 4 --mem 6G --disk 20G
...
multipass exec master -- bash -c 'sudo apt-get install -y apt-transport-https ca-certificates curl gnupg lsb-release'
